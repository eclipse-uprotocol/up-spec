...
* contains a _wildcard_ _service type ID_ (_least_ significant 16 bits of `ue_id`) or
...
[.specitem,oft-sid="req~usubscription-change-publication~1",oft-needs="dsn,impl,utest",oft-tags="USubscription"]
