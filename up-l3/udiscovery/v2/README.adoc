...
`ResolveUri()` is used to lookup names from ids or vice versa meaning to go to/from Long Uri from/to Short Uri. 
 ...
 * *MUST* be passed either a Long or Short form URI and return both the Short and Long form URI if successful
