...
<<publish error-flow>> figure below illustrates the sequence of messages for Publish flows and the role dispatchers play in error handling.

.PUBLISH ERROR FLOW
[#publish-err0r-flow]
image::publish_flow.png[Publish Error Handling]
