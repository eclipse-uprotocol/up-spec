...
|*uApplication* |A uEntity that performs the role of consumer
|*uService* |A uEntity that performs the role of producer whos interfaces are defined with a protobuf IDL
