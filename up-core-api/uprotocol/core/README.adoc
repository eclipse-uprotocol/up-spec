...
Core uProtocol services interfaces are defined using asyncapi, with pointers to supported message serialization formats.
...
Core uProtocol services API request and response messages can be defined to support any desired serialization format. The current default format is protobuf.
...
| Request and response message definitions for publishers and subscribers to subscribe/publish to topics
