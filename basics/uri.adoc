...
Uri Interface defines the common APIs that all objects *MUST* implement. APIs are described in the table below.
...
| `toString(): String`
| Returns a string that represents the object used for validation

| `equals(Object): boolean`
| Returns true if the object is equal to the other object

| `isLongFormat(): boolean`
| Returns true if the object contains names such that it can be serialize to <<Long Format>>
